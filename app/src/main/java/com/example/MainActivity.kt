...
fun MainApp(
    ...
    MyApplicationTheme(
        ...
        var navigationStack by remember { mutableStateOf(listOf(initialTab)) }
            ...
            bottomBar = {
                NavigationBar {
                    ...
                    NavigationBarItem(
                        ...
                        icon = {
                            Icon(
                                imageVector = if (selectedTab == 1) Icons.AutoMirrored.Filled.List else Icons.AutoMirrored.Outlined.List,
